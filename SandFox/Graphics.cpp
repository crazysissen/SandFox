...
void Graphics::FrameBegin(const cs::Color& color)
{
...
void Graphics::InitCamera(Vec3 pos, Vec3 rot, float fov)
{
...
const dx::XMMATRIX& Graphics::GetCameraMatrix()
{
